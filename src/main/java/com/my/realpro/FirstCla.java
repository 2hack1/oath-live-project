...
// Default page come on web***********
 ...
 //Ragister page load********
	...
	public String form(Model m) {
		System.out.println("Void Is Work!");
		setOtpMatch("");
		if (getRmess()==null) {
			setRmess(" ");
...
// All the data of Register page are going on jsp page*******
	...
	public String ga(@RequestParam("name") String ka, @RequestParam("email") String ea, @RequestParam("pass") int pass,
		...
		Iterator<Nagrik> iterator = hibernetDao.getfiFirstClas().iterator();
		while (iterator.hasNext()) {
			Nagrik enty = iterator.next();
		...
		Nagrik hh = new Enty(ka, ea, pass, gender);
