...
<body>
 ...
 <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqOLLQ9hAOSAhDu6viwcuO4cUxWgeKXo52Ug&s" alt="Emblem" class="emblem">
	...
	<div class="container">
	<h1 style=" color:red;"><%= nagrikMatch %></h1>
		<h1>Register</h1>
		<div class="steps">
			<div class="step">
				<div class="step-number">1</div>
				<div class="step-text">
					बुनियादी विवरण दर्ज कीजिये<br>ENTER BASIC DETAILS
				</div>
			</div>
			<div class="step">
				<div class="step-number">2</div>
				<div class="step-text">
					प्रतिज्ञा की भाषा चुनिये<br>SELECT PLEDGE LANGUAGE
				</div>
			</div>
			<div class="step">
				<div class="step-number">3</div>
				<div class="step-text">
					पढ़ें और प्रतिज्ञा लें<br>READ & TAKE PLEDGE
				</div>
			</div>
		</div>
		<form action="orgNagrikData" method="post">
			<div class="form-group">
				<label for="name"> Name</label> <input type="text" id="name"
					name="name" placeholder="Enter your Founder name" required>
			</div>
			<div class="form-group">
				<label for="email"> Email</label> <input type="email" id="email"
					name="email" placeholder="Enter your Founder email" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="zip-code">Zip Code</label> <input type="text"
					id="zip-code" name="zip_code" placeholder="Enter your zip code"
					required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="pin-code">Pin Code</label> <input type="text"
					id="pin-code" name="pin_code" placeholder="Enter your pin code"
					required>
			</div>

			<div class="form-group">
				<label for="organization-name">Organization Name</label> <input
					type="text" id="organization-name" name="org_name"
					placeholder="Enter organization name" required>
			</div>

			<div class="form-group">
				<label for="document-type">Document Type (Optional)</label> <select
					id="document-type" name="doc_type">
					<option value="">Select document type</option>
					<option value="pan-card">PAN Card </option>
					<option value="org-registration">Organization Registration</option>
					<option value="aadhar-card">Aadhar Card</option>
				</select>
			</div>
		<!-- 	<div class="form-group">
				<label for="document-upload">Upload Document (Optional)</label> <input
					type="file" id="document-upload" name="document-upload"
					accept="image/*">
			</div> -->

           <div class="form-group">
				<label for="pin-code">doc_id no.(optional)</label> <input type="text"
					id="pin-code" name="doc_id" placeholder="Enter your Document Id No.">
			</div>
